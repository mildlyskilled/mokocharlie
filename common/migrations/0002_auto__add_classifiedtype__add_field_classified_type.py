...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Classified.type'
        db.add_column(u'common_classified', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['common.ClassifiedType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Classified.type'
        db.delete_column(u'common_classified', 'type_id')
    ...
    models = {
        ...
        u'common.classified': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.ClassifiedType']"}),
