...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collections.created_at'
        db.add_column(u'collection', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 25, 0, 0)),
                      keep_default=False)

        # Adding field 'Collections.updated_at'
        db.add_column(u'collection', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collections.created_at'
        db.delete_column(u'collection', 'created_at')

        # Deleting field 'Collections.updated_at'
        db.delete_column(u'collection', 'updated_at')
    ...
    models = {
        ...
        u'common.collections': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 25, 0, 0)'})
        },
        u'common.comment': {
