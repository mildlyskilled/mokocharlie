...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'common_classified', (
            ...
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 25, 0, 0))),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('published_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('unpublish_date', self.gf('django.db.models.fields.DateTimeField')()),
    ...
    models = {
        ...
        u'common.classified': {
            ...
            'unpublish_date': ('django.db.models.fields.DateTimeField', [], {}),
