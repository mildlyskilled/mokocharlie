...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collections.description'
        db.add_column(u'collection', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collections.description'
        db.delete_column(u'collection', 'description')
