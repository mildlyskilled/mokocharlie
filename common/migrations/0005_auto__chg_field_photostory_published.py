...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhotoStory.published'
        db.alter_column(u'photo_stories', 'published', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'PhotoStory.published'
        db.alter_column(u'photo_stories', 'published', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'common.favourite': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 0, 0)'}),
