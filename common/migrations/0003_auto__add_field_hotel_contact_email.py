...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hotel.contact_email'
        db.add_column(u'hospitality', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(default=u'hotelinquiry@mokocharlie.com', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hotel.contact_email'
        db.delete_column(u'hospitality', 'contact_email')
