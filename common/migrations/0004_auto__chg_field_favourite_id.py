...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Favourite.id'
        db.alter_column(u'favourite', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Favourite.id'
        db.alter_column(u'favourite', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
