...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collections.cover_album'
        db.add_column(u'collection', 'cover_album',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cover_album', null=True, to=orm['common.Album']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collections.cover_album'
        db.delete_column(u'collection', 'cover_album_id')
